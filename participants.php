...
$PAGE->set_url('/local/recertify/participants.php', array(
    'page' => $page,
    'perpage' => $perpage,
    'contextid' => $contextid,
    'id' => $courseid,
...
$filterset = new \local_recertify\table\participants_filterset();
$filterset->add_filter(new integer_filter('courseid', filter::JOINTYPE_DEFAULT, [(int)$course->id]));

$participanttable = new \local_recertify\table\participants("user-recertify-participants-{$course->id}");
...
if ($bulkoperations) {
    ...
    echo '<input type="submit" name="submit" value="'.get_string('bulkchangedate', 'local_recertify').'"/>';
    echo '<input type="submit" name="reset_completion" value="'.get_string('bulkresetallcompletion', 'local_recertify').'"/>';
