...
$string['noemailprofilefield'] = 'Profilfeld für Mitarbeiter ohne E-Mail-Adresse';
$string['noemailprofilefield_help'] = 'Shortname eines Custom User Profile Fields (z.B. eine Checkbox), das markiert, dass ein Benutzer keine echte E-Mail-Adresse hat. Bei diesen Benutzern wird im Statusbericht ein Passwort-Reset durchgeführt und die neuen Zugangsdaten an die Vorgesetzten gesendet. Leer lassen, um die Funktion zu deaktivieren.';
