...
$PAGE->set_url('/local/recertify/recertify.php', array('id' => $course->id));
$PAGE->set_title($course->shortname);
$PAGE->set_heading($course->fullname);
$PAGE->set_pagelayout('admin');

$config = $DB->get_records_list('local_recertify_config', 'course', array($course->id), '', 'name, id, value');
...
$setnames = array('enable', 'recertifyduration', 'deletegradedata', 'archivecompletiondata',
...
$form = new local_recertify_recertify_form('recertify.php?id='.$id, array('course' => $course));
